...
from unet import Unet_CNN, UNet_multi_class
from metric import *
...
def train_net(net,
    ...
    for epoch in range(epochs):
        ...
        torch.save(net.state_dict(), './CP_skip_unet_2d_celoss/' + 'CP{}.pth'.format(epoch + 1))
    ...
    output_dice_hd_pat(
        ...
        [epochs_dice_ED_endo_val, epochs_dice_ED_epi_val, epochs_dice_ED_la_val, epochs_dice_ES_endo_val,
         ...
         epochs_hd_ED_la_val,epochs_hd_ES_endo_val, epochs_hd_ES_epi_val, epochs_hd_ES_la_val],
            './output/data/skip_unet_2d_celoss/')
...
if __name__ == '__main__':
    ...
    high_dim = 64
    load_model = False
    #net = Unet_CNN(n_channels=1, n_classes=4, high_represent_dim=high_dim)
    net = UNet_multi_class(n_channels=1, n_classes=4)
    net.cuda()
    if load_model:
        net.load_state_dict(torch.load('./CP_skip_unet_2d_celoss/CP25.pth'))
